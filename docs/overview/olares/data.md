...
Considering that managing data on Kubernetes is a troublesome matter, Olares hopes to take on this responsibility, optimize it from a system perspective, and provide developers with the same data hosting services as public clouds. Developers only need to focus on business logic.
...
- User
  ...
  [File Management Tool](../../how-to/olares/files/)<br>
  [Use Settings to back up](../../how-to/olares/settings/backup.md)<br>
  How to use the [Backup & Restore](../../how-to/space/backup.md#backup) function of Olares Space to view backup records, and restore Olares to the local machine and Olares Space through backup.
