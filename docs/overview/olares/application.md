...
You can view the applications existing in the system through [ControlHub](../../how-to/olares/controlhub/browse.md) and distinguish application types according to `namespace`:
